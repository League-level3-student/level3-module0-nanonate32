...
public class _03_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		// created in step 3
		buttons = new JButton[Integer.parseInt(response)];
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button NOW!");
		// 13. initialize the hiddenButton variable to a random number less than
		// the int created in step 3
		Random random = new Random();
		hiddenButton = random.nextInt(Integer.parseInt(response));
